...
// search Bar
  ...
  const searchlist = async (e)=>{
    ...
    const search1 = await axios.post(`${abd}/blog/cSearch`,body).then((res)=>{
      console.log(res.data.data)
  ...
  const recentlist= async () =>{
      const recent1= await axios.get(`${abd}/blog/cSort`).then((res)=>{
        console.log(res.data.data)
